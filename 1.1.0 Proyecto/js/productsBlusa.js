...
for (const blusa of blusas) {
    ...
    nombre.textContent = blusa.nombre
    info.appendChild(nombre)
        //Precio del Producto
    let precio = document.createElement("h5")
    precio.textContent = "$" + blusa.precio
    ...
    botonCarrito.setAttribute("marcador", blusa.ref)
    botonCarrito.setAttribute("id", blusa.ref)
        // botonCarrito.addEventListener("click", agregarCarrito("${blusa.ref}"))
