...
for (const pareja of parejas) {
    ...
    nombre.textContent = pareja.nombre
    info.appendChild(nombre)
        //Precio del Producto
    let precio = document.createElement("h5")
    precio.textContent = "$" + pareja.precio
    ...
    botonCarrito.setAttribute("marcador", pareja.ref)
    botonCarrito.setAttribute("id", pareja.ref)
        // botonCarrito.addEventListener("click", agregarCarrito("${pareja.ref}"))
